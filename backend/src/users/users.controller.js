...
var UsersController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, common_1.Controller)('users')];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.create = function (dto, req) {
            var _a;
            return this.usersService.create(dto, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
        ...
        UsersController_1.prototype.update = function (id, dto, req) {
            var _a;
            return this.usersService.update(id, dto, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
        UsersController_1.prototype.remove = function (id, req) {
            var _a;
            return this.usersService.remove(id, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)('ADMIN')];
        _getStats_decorators = [(0, common_1.Get)('stats'), (0, roles_decorator_1.Roles)('ADMIN')];
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, roles_decorator_1.Roles)('ADMIN')];
