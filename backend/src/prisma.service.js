...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1() {
            var dbUrl = process.env.DATABASE_URL || 'file:./dev.db';
            var dbPath = dbUrl.replace(/^file:/, '');
            var adapter = new adapter_better_sqlite3_1.PrismaBetterSqlite3({ url: dbPath });
            return _super.call(this, { adapter: adapter }) || this;
        }
