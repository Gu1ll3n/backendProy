...
var AppointmentsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('appointments')];
    ...
    var AppointmentsController = _classThis = /** @class */ (function () {
        ...
        AppointmentsController_1.prototype.create = function (dto, req) {
            var _a;
            return this.appointmentsService.create(dto, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
        AppointmentsController_1.prototype.findAll = function (patientId, doctorId, status, from, to) {
        ...
        AppointmentsController_1.prototype.getDashboardStats = function () {
            return this.appointmentsService.getDashboardStats();
        };
        AppointmentsController_1.prototype.findOne = function (id) {
            return this.appointmentsService.findOne(id);
        };
        AppointmentsController_1.prototype.update = function (id, dto, req) {
            var _a;
            return this.appointmentsService.update(id, dto, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
        AppointmentsController_1.prototype.remove = function (id, req) {
            var _a;
            return this.appointmentsService.remove(id, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
