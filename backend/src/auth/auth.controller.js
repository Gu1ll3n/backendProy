...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.getCaptcha = function () {
        ...
        AuthController_1.prototype.login = function (dto, req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.authService.login(dto, ip, userAgent)];
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ip = req.headers['x-forwarded-for'] ||
                        ...
                        'unknown';
                    userAgent = req.headers['user-agent'] || 'unknown';
                    return [2 /*return*/, this.authService.logout(req.user.id, ip, userAgent)];
                });
            });
        };
    ...
    (function () {
        ...
        _getCaptcha_decorators = [(0, common_1.Get)('captcha')];
        ...
        __esDecorate(_classThis, null, _getCaptcha_decorators, { kind: "method", name: "getCaptcha", static: false, private: false, access: { has: function (obj) { return "getCaptcha" in obj; }, get: function (obj) { return obj.getCaptcha; } }, metadata: _metadata }, null, _instanceExtraInitializers);
