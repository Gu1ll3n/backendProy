...
var PatientsController = function () {
    ...
    var PatientsController = _classThis = /** @class */ (function () {
        ...
        PatientsController_1.prototype.create = function (dto, req) {
            var _a;
            return this.patientsService.create(dto, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
        PatientsController_1.prototype.findAll = function (search) {
            return this.patientsService.findAll(search);
        };
        PatientsController_1.prototype.findOne = function (id) {
            return this.patientsService.findOne(id);
        };
        PatientsController_1.prototype.update = function (id, dto, req) {
            var _a;
            return this.patientsService.update(id, dto, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
        PatientsController_1.prototype.remove = function (id, req) {
            var _a;
            return this.patientsService.remove(id, (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub);
        };
